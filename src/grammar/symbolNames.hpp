...
const unordered_map<int, string> symbolNames {
    ...
    {Reference, "Reference"},
    {Dereference, "Dereference"},
    {IdentifierOperation, "IdentifierOperation"},
    {Variable, "Variable"},
    {Literal, "Literal"},
    {InputTerm, "InputTerm"},
    ...
    {NonConstDeclaration_0, "NonConstDeclaration_0"},
    {NonConstDeclaration, "NonConstDeclaration"},
    ...
    {L_Case_2, "L_Case_2"},
    {Switch_0, "Switch_0"},
    {N_Switch_1, "N_Switch_1"},
    {L_Switch_1, "L_Switch_1"},
    {Parameter, "Parameter"},
    ...
    {FunctionCallSuffix, "FunctionCallSuffix"},
